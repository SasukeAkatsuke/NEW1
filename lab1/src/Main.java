...
public class Main {
    public static void main(String[] args) throws IOException {
        for(;;) {
            ...
            list2.add(new User("Asya", 20));
            list2.add(new User("Vadim", 18));
            list2.add(new User("Denis", 25));

            System.out.println(list2);
            System.out.println(list2.contains(new User("Asya", 30)));
            System.out.println(list2.contains(new User("Asya", 20)));
            break;
        }
